...
-------------
可以参考下《Innodb中的事务隔离级别和锁的关系》https://www.jianshu.com/p/890adca63a67
注：美团技术团队队分享已经取消，csdn上本来有此文，但是必须登录才能查看。故修改此链接。
```
...
笔试题的解法见[php7.php](./php/Level/php7.php)文件中的24、25、26
